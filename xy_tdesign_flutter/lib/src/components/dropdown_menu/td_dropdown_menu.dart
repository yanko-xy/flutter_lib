...
class TDDropdownMenu extends StatefulWidget {
  ...
  /// 菜单打开前事件
  final FutureOr<void> Function(int index)? onBeforeMenuOpened;
...
class _TDDropdownMenuState extends State<TDDropdownMenu>
  ...
  Widget _tabBarContent(int index) {
    ...
    return GestureDetector(
      ...
      onTap: () async {
        ...
        await widget.onBeforeMenuOpened?.call(index);
      ...
      child: Row(
        ...
        children: [Flexible(child: _getText(index)), if (icon != null) icon],
      ),
    );
  }
  ...
  _getIcon(int index) {
    var arrowIcon = _items![index].arrowIcon ?? widget.arrowIcon;
    if (arrowIcon != null) {

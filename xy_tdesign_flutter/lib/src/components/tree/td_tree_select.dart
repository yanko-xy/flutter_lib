...
class TDTreeSelect extends StatefulWidget {
  const TDTreeSelect({
    ...
    this.height = 336,
    this.width = 76,
    this.sideBarContentPadding,
    this.sideBarSelectedBgColor,
    this.sideBarUnSelectedBgColor,
    this.sideBarSelectedColor,
    this.sideBarUnSelectedColor,
    this.sideBarSelectedTextStyle,
  ...
  /// 侧边栏内容padding
  final EdgeInsetsGeometry? sideBarContentPadding;

  /// 选择的背景颜色
  final Color? sideBarSelectedBgColor;

  /// 未选择的背景颜色
  final Color? sideBarUnSelectedBgColor;
  ...
  /// 侧边栏选择textStyle
  final TextStyle? sideBarSelectedTextStyle;
      ...
      children: [
        SizedBox(
          ...
          child: TDSideBar(
            ...
            contentPadding: widget.sideBarContentPadding,
            selectedBgColor: widget.sideBarSelectedBgColor,
            unSelectedBgColor: widget.sideBarUnSelectedBgColor,
            selectedColor: widget.sideBarSelectedColor,
            unSelectedColor: widget.sideBarUnSelectedColor,
            selectedTextStyle: widget.sideBarSelectedTextStyle,
            ...
            children: widget.options
                .map((ele) => TDSideBarItem(
                      value: ele.value,
                      label: ele.label,
                      textStyle: ele.textStyle ?? widget.sideBarTextStyle,
                    ))
                .toList(),
            onSelected: (value) {
              setState(() {
        ...
        Expanded(
            child: Container(
          height: widget.height,
          decoration: BoxDecoration(color: widget.contentBackgroundColor),
